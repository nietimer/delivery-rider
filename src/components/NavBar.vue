<template>
    <nav class="navbar">
        <router-link to="/delivery" class="nav-item" :class="{ active: $route.path === '/delivery' }">
            <i class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
